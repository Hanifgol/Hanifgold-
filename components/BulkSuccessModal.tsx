    ...
    return (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4" aria-modal="true" role="dialog">
            <div className="bg-white rounded-xl shadow-xl max-w-lg w-full text-center p-8">
                ...
                <h2 className="text-2xl font-bold text-secondary mt-4">Generation Complete</h2>
                <p className="text-gray-600 mt-2">
                    Successfully generated <span className="font-bold text-primary">{successfulCount}</span> new quotation{successfulCount !== 1 ? 's' : ''}.
                </p>
                ...
                <div className="mt-6 space-y-3">
                     ...
                     <button 
                        ...
                        className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-sky-100 text-primary font-bold rounded-lg hover:bg-sky-200 transition"
                    >
                    ...
                    <button 
                        ...
                        className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-gray-100 text-gray-700 font-bold rounded-lg hover:bg-gray-200 transition"
                    >
                ...
                <div className="mt-8">
                    <button onClick={onClose} className="text-sm font-semibold text-gray-500 hover:text-secondary">
                        Close
                    </button>
                </div>
            </div>
